...
class hud_renderer
{
    public static void draw_character_bars(SDL_Renderer* renderer, character c, bool is_party, combat_state state, int actions_left, float game_time)
    {
        if (is_party)
        {
            draw_utils.draw_bar(renderer, c.x, c.y - 12, c.health, c.max_health, colors.GREEN[0], colors.GREEN[1], colors.GREEN[2]);
            draw_utils.draw_bar(renderer, c.x, c.y - 20, c.tp, c.max_tp, colors.GOLD[0], colors.GOLD[1], colors.GOLD[2]);
        ...
        {
            draw_utils.draw_bar(renderer, c.x, c.y - 12, c.health, c.max_health, colors.RED[0], colors.RED[1], colors.RED[2]);
            ...
            draw_utils.draw_bar(renderer, c.x, c.y - 20, c.stagger, c.max_stagger, sr, sg, sb);
            draw_utils.draw_bar(renderer, c.x, c.y - 28, c.mercy_bar, c.max_mercy_bar, colors.BLUE[0], colors.BLUE[1], colors.BLUE[2]);
        }
    }
